...
- ⬜ **Phase 3b (flip + UI):** recalibrate threshold/margin from real enrolled separation, build the review-bucket admin UI (list/promote/dismiss over the new endpoints), then flip `speaker_controlled_enrollment_enabled` on.
