...
random.seed(0)
MODEL = "/work/my_custom_model/renfield.onnx"
...
def score_wav(path):
    ...
    return mx
pos = glob.glob("/work/my_custom_model/renfield/positive_test/*.wav"); random.shuffle(pos)
neg = glob.glob("/work/my_custom_model/renfield/negative_test/*.wav"); random.shuffle(neg)
